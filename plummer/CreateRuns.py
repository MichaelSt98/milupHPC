...
class Run(object):
    ...
    def __init__(self, settings, base_directory, submit_template_binac, submit_template_naboo, config_template):
        ...
        self.simulation_type = "pl"
        self.simulation_type_postprocessing = 0
        self.pmem = "10gb"
        self.wall_time = "02:00:00"
        self.initial_distribution = self.get_initial_distribution_files("initial_plummer/")
    ...
    def get_initial_distribution_files(directory="./"):
        ...
        for h5_file in h5_files:
            regex = re.search("(plN)([0-9]+)", h5_file).groups()
    ...
    def create_run(self, index=0):
        ...
        # print("theta: {}".format(float(self.settings["theta"][index])))
        # print("force version: {}".format(int(self.settings["computeForceVersion"][index])))
        ...
        # print("smoothing: {}".format(float(self.settings["smoothing"][index])))
        # command line
    ...
    def _create_post_run(self, index):
        ...
        file_content += "\n"
        file_content += "\n"
        file_content += "./postprocessing/PlotPlummer.py -Q -d {} -o {}".format(self.base_directory + self.get_simulation_directory(index) + "/",
